...
from networks.HRNet.modules import BasicBlock, Bottleneck
...
class HRNet(nn.Module):
    def __init__(self, c=48, inchannels=3, num_joints=17, bn_momentum=0.1):
        ...
        self.final_layer = nn.Conv2d(c, num_joints, kernel_size=(1, 1), stride=(1, 1))
...
if __name__ == '__main__':
    ...
    model = HRNet(c=32, num_joints=32, bn_momentum=0.1)
